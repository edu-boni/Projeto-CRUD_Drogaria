...
<main class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
  <div class="w-100" style="max-width: 600px;">
    <h3 class="text-center text-info mb-4">Cadastro de Administrador</h3>
    ...
    <form action="<%= request.getContextPath() %>/CreateAdminServlet" method="post">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="email" id="email" name="email" class="form-control" placeholder="email@farmacia.com" required>
        </div>
      ...
      <div class="mt-4 d-flex justify-content-between align-items-center">
        <a href="<%= request.getContextPath() %>/adm/login.jsp" class="btn btn-outline-secondary">Voltar ao Login</a>
