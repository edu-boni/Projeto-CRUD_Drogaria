...
<div class="container mt-5 mb-5">
    ...
    <form action="<%= contextPath %>/UpdateADMServlet" method="post" class="row">
		<%
		...
		%>
		<input type="hidden" name="id" value="<%= (a != null) ? a.getId() : 0 %>"/>
		...
		<div class="form-group col-md-6">
		    ...
		    <small>
		        <a href="#" data-toggle="modal" data-target="#alterarSenhaModal">Alterar senha</a>
		    </small>
		</div>
        ...
        <div class="form-group col-12 text-center mt-3">
            ...
            <a href="./DeleteADMServlet?id=<%= a.getId() %>" class="btn btn-danger ml-2">Excluir Conta</a>
        </div>
    </form>
    <!-- Modal de alteração de senha -->
	<div class="modal fade" id="alterarSenhaModal" tabindex="-1" role="dialog" aria-labelledby="modalLabelSenha" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<form action="<%= contextPath %>/UpdateADMServlet" method="post" class="modal-content">
